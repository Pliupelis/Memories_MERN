...
const Form=()=>{
    const [postData, setPostData] = useState({
        creator: '', title: '', msg: '', tags: '', selectedFile: ''
    })
...
<Paper className={classes.paper}>
    <form autoComplete="off" noValidate className={`${classes.root} ${classes.form}`} onSubmit={handleSubmit}>
        ...
        <TextField name='msg'variant='outlined'label='Msg' fullWidth value={postData.msg} onChange={(e)=> setPostData({...postData, msg: e.target.value})}/>
